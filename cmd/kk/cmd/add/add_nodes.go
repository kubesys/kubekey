...
import (
	...
	"github.com/kubesys/kubekey/v3/cmd/kk/cmd/util"
	"github.com/kubesys/kubekey/v3/cmd/kk/pkg/common"
	"github.com/kubesys/kubekey/v3/cmd/kk/pkg/pipelines"
)
...
func (o *AddNodesOptions) AddFlags(cmd *cobra.Command) {
	...
	cmd.Flags().BoolVarP(&o.SkipEtcd, "skip-etcd", "", false, "Skip etcd certificate and backup modules")
}
