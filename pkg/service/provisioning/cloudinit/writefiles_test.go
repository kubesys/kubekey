...
import (
	...
	"github.com/kubesys/kubekey/pkg/service/provisioning/commands"
)
	...
	var useCases = []struct {
	...
	}{
		{
			...
			expectedCmds: []commands.Cmd{
				...
				{Cmd: "/bin/sh", Args: []string{"-c", "echo 'bar' > foo"}},
				{Cmd: "mkdir", Args: []string{"-p", "."}},
				{Cmd: "/bin/sh", Args: []string{"-c", "echo 'qux' > baz"}},
			},
		},
		{
